            ...
            <div class="search-input-bar row1">
                <div class="input-group">
                    <div class="inner-addon right-addon">
                        ...
                        <div class="addon"><button id="transferbutton" title="Transfer" class="btn btn-default btn-hx-transfer" type="button"><i class="glyphicon glyphicon-transfer"></i></button><button id="searchbutton" disabled class="btn btn-default btn-hx-search" type="button"><i class="glyphicon glyphicon-search"></i></button></div>
                    </div>
                </div>
            </div>
