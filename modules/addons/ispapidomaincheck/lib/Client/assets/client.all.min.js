 ...
 * Copyright (c) 2013 Jonny Reeves; Licensed MIT */(function(e,n){"use strict";var r={},t=null,i={warnOnMissingTemplates:!1,allowOverwrite:!0,domTemplateType:"text/html",externalTemplateDataType:"text"};function s(){return t===null&&(t=n.Mustache,t===void 0&&e.error("Failed to locate Mustache instance, are you sure it has been loaded?")),t}function a(p){return r[p]!==void 0}function o(p,U){if(!i.allowOverwrite&&a(p)){e.error("TemplateName: "+p+" is already mapped.");return}r[p]=e.trim(U)}function u(){var p;arguments.length===0?p=e('script[type="'+i.domTemplateType+'"]').map(function(){return this.id}):p=e.makeArray(arguments),e.each(p,function(){var U=document.getElementById(this);U===null?e.error("No such elementId: #"+this):o(this,e(U).html())})}function k(p){var U=r[p];return delete r[p],U}function A(){r={},s().clearCache()}function E(p,U){return a(p)?s().to_html(r[p],U,r):(i.warnOnMissingTemplates&&e.error("No template registered for: "+p),"")}function m(p,U){return e.ajax({url:p,dataType:i.externalTemplateDataType}).done(function(I){e(I).filter("script").each(function(g,O){o(O.id,e(O).html())}),e.isFunction(U)&&U()})}function C(){return e.map(r,function(p,U){return U})}e.Mustache={options:i,load:m,has:a,add:o,addFromDom:u,remove:k,clear:A,render:E,templates:C,instance:t},e.fn.mustache=function(p,U,I){var g=e.extend({method:"append"},I),O=function(L,G){e(L)[g.method](E(p,G))};return this.each(function(){var L=this;e.isArray(U)?e.each(U,function(){O(L,this)}):O(L,U)})}})(window.jQuery||window.Zepto,window),function(n,r){typeof exports=="object"&&exports&&typeof exports.nodeName!="string"?r(exports):typeof define=="function"&&define.amd?define(["exports"],r):(n.Mustache={},r(n.Mustache))}(this,function(n){var r=Object.prototype.toString,t=Array.isArray||function(c){return r.call(c)==="[object Array]"};function i(w){return typeof w=="function"}function s(w){return t(w)?"array":typeof w}function a(w){return w.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&")}function o(w,c){return w!=null&&typeof w=="object"&&c in w}function u(w,c){return w!=null&&typeof w!="object"&&w.hasOwnProperty&&w.hasOwnProperty(c)}var k=RegExp.prototype.test;function A(w,c){return k.call(w,c)}var E=/\S/;function m(w){return!A(E,w)}var C={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;","`":"&#x60;","=":"&#x3D;"};function p(w){return String(w).replace(/[&<>"'`=\/]/g,function(h){return C[h]})}var U=/\s*/,I=/\s+/,g=/\s*=/,O=/\s*\}/,L=/#|\^|\/|>|\{|&|=|!/;function G(w,c){if(!w)return[];var h=[],l=[],f=[],v=!1,D=!1;function S(){if(v&&!D)for(;f.length;)delete l[f.pop()];else f=[];v=!1,D=!1}var y,d,b;function x(q){if(typeof q=="string"&&(q=q.split(I,2)),!t(q)||q.length!==2)throw new Error("Invalid tags: "+q);y=new RegExp(a(q[0])+"\\s*"),d=new RegExp("\\s*"+a(q[1])),b=new RegExp("\\s*"+a("}"+q[1]))}x(c||n.tags);for(var P=new J(w),R,T,_,F,z,B;!P.eos();){if(R=P.pos,_=P.scanUntil(y),_)for(var M=0,W=_.length;M<W;++M)F=_.charAt(M),m(F)?f.push(l.length):D=!0,l.push(["text",F,R,R+1]),R+=1,F===`
`&&S();if(!P.scan(y))break;if(v=!0,T=P.scan(L)||"name",P.scan(U),T==="="?(_=P.scanUntil(g),P.scan(g),P.scanUntil(d)):T==="{"?(_=P.scanUntil(b),P.scan(O),P.scanUntil(d),T="&"):_=P.scanUntil(d),!P.scan(d))throw new Error("Unclosed tag at "+P.pos);if(z=[T,_,R,P.pos],l.push(z),T==="#"||T==="^")h.push(z);else if(T==="/"){if(B=h.pop(),!B)throw new Error('Unopened section "'+_+'" at '+R);if(B[1]!==_)throw new Error('Unclosed section "'+B[1]+'" at '+R)}else T==="name"||T==="{"||T==="&"?D=!0:T==="="&&x(_)}if(B=h.pop(),B)throw new Error('Unclosed section "'+B[1]+'" at '+P.pos);return V(X(l))}function X(w){for(var c=[],h,l,f=0,v=w.length;f<v;++f)h=w[f],h&&(h[0]==="text"&&l&&l[0]==="text"?(l[1]+=h[1],l[3]=h[3]):(c.push(h),l=h));return c}function V(w){for(var c=[],h=c,l=[],f,v,D=0,S=w.length;D<S;++D)switch(f=w[D],f[0]){case"#":case"^":h.push(f),l.push(f),h=f[4]=[];break;case"/":v=l.pop(),v[5]=f[2],h=l.length>0?l[l.length-1][4]:c;break;default:h.push(f)}return c}function J(w){this.string=w,this.tail=w,this.pos=0}J.prototype.eos=function(){return this.tail===""},J.prototype.scan=function(c){var h=this.tail.match(c);if(!h||h.index!==0)return"";var l=h[0];return this.tail=this.tail.substring(l.length),this.pos+=l.length,l},J.prototype.scanUntil=function(c){var h=this.tail.search(c),l;switch(h){case-1:l=this.tail,this.tail="";break;case 0:l="";break;default:l=this.tail.substring(0,h),this.tail=this.tail.substring(h)}return this.pos+=l.length,l};function N(w,c){this.view=w,this.cache={".":this.view},this.parent=c}N.prototype.push=function(c){return new N(c,this)},N.prototype.lookup=function(c){var h=this.cache,l;if(h.hasOwnProperty(c))l=h[c];else{for(var f=this,v,D,S,y=!1;f;){if(c.indexOf(".")>0)for(v=f.view,D=c.split("."),S=0;v!=null&&S<D.length;)S===D.length-1&&(y=o(v,D[S])||u(v,D[S])),v=v[D[S++]];else v=f.view[c],y=o(f.view,c);if(y){l=v;break}f=f.parent}h[c]=l}return i(l)&&(l=l.call(this.view)),l};function j(){this.cache={}}j.prototype.clearCache=function(){this.cache={}},j.prototype.parse=function(c,h){var l=this.cache,f=c+":"+(h||n.tags).join(":"),v=l[f];return v==null&&(v=l[f]=G(c,h)),v},j.prototype.render=function(c,h,l,f){var v=this.parse(c,f),D=h instanceof N?h:new N(h);return this.renderTokens(v,D,l,c,f)},j.prototype.renderTokens=function(c,h,l,f,v){for(var D="",S,y,d,b=0,x=c.length;b<x;++b)d=void 0,S=c[b],y=S[0],y==="#"?d=this.renderSection(S,h,l,f):y==="^"?d=this.renderInverted(S,h,l,f):y===">"?d=this.renderPartial(S,h,l,v):y==="&"?d=this.unescapedValue(S,h):y==="name"?d=this.escapedValue(S,h):y==="text"&&(d=this.rawValue(S)),d!==void 0&&(D+=d);return D},j.prototype.renderSection=function(c,h,l,f){var v=this,D="",S=h.lookup(c[1]);function y(x){return v.render(x,h,l)}if(!!S){if(t(S))for(var d=0,b=S.length;d<b;++d)D+=this.renderTokens(c[4],h.push(S[d]),l,f);else if(typeof S=="object"||typeof S=="string"||typeof S=="number")D+=this.renderTokens(c[4],h.push(S),l,f);else if(i(S)){if(typeof f!="string")throw new Error("Cannot use higher-order sections without the original template");S=S.call(h.view,f.slice(c[3],c[5]),y),S!=null&&(D+=S)}else D+=this.renderTokens(c[4],h,l,f);return D}},j.prototype.renderInverted=function(c,h,l,f){var v=h.lookup(c[1]);if(!v||t(v)&&v.length===0)return this.renderTokens(c[4],h,l,f)},j.prototype.renderPartial=function(c,h,l,f){if(!!l){var v=i(l)?l(c[1]):l[c[1]];if(v!=null)return this.renderTokens(this.parse(v,f),h,l,v)}},j.prototype.unescapedValue=function(c,h){var l=h.lookup(c[1]);if(l!=null)return l},j.prototype.escapedValue=function(c,h){var l=h.lookup(c[1]);if(l!=null)return n.escape(l)},j.prototype.rawValue=function(c){return c[1]},n.name="mustache.js",n.version="3.0.1",n.tags=["{{","}}"];var K=new j;return n.clearCache=function(){return K.clearCache()},n.parse=function(c,h){return K.parse(c,h)},n.render=function(c,h,l,f){if(typeof c!="string")throw new TypeError('Invalid template! Template should be a "string" but "'+s(c)+'" was given as the first argument for mustache#render(template, view, partials)');return K.render(c,h,l,f)},n.to_html=function(c,h,l,f){var v=n.render(c,h,l);if(i(f))f(v);else return v},n.escape=p,n.Scanner=J,n.Context=N,n.Writer=j,n});var _createClass=function(){function e(n,r){for(var t=0;t<r.length;t++){var i=r[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(n,i.key,i)}}return function(n,r,t){return r&&e(n.prototype,r),t&&e(n,t),n}}();function _classCallCheck(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}(function(){"use strict";var e,n,r;e=jQuery,n=function(){var t=function(){function i(){_classCallCheck(this,i)}return _createClass(i,null,[{key:"transition",value:function(a){var o,u,k,A;o=a[0],u=this.transitions;for(A in u)if(k=u[A],o.style[A]!=null)return k}}]),i}();return t.transitions={webkitTransition:"webkitTransitionEnd",mozTransition:"mozTransitionEnd",oTransition:"oTransitionEnd",transition:"transitionend"},t}(),r=function(){var t=function(){_createClass(i,null,[{key:"growl",value:function(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};return new i(a)}}]);function i(){var s=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};_classCallCheck(this,i),this.render=this.render.bind(this),this.bind=this.bind.bind(this),this.unbind=this.unbind.bind(this),this.mouseEnter=this.mouseEnter.bind(this),this.mouseLeave=this.mouseLeave.bind(this),this.click=this.click.bind(this),this.close=this.close.bind(this),this.cycle=this.cycle.bind(this),this.waitAndDismiss=this.waitAndDismiss.bind(this),this.present=this.present.bind(this),this.dismiss=this.dismiss.bind(this),this.remove=this.remove.bind(this),this.animate=this.animate.bind(this),this.$growls=this.$growls.bind(this),this.$growl=this.$growl.bind(this),this.html=this.html.bind(this),this.content=this.content.bind(this),this.container=this.container.bind(this),this.settings=e.extend({},i.settings,s),this.initialize(this.settings.location),this.render()}return _createClass(i,[{key:"initialize",value:function(a){var o;return o="growls-"+a,e("body:not(:has(#"+o+"))").append('<div id="'+o+'" />')}},{key:"render",value:function(){var a;a=this.$growl(),this.$growls(this.settings.location).append(a),this.settings.fixed?this.present():this.cycle()}},{key:"bind",value:function(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:this.$growl();return a.on("click",this.click),this.settings.delayOnHover&&(a.on("mouseenter",this.mouseEnter),a.on("mouseleave",this.mouseLeave)),a.on("contextmenu",this.close).find("."+this.settings.namespace+"-close").on("click",this.close)}},{key:"unbind",value:function(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:this.$growl();return a.off("click",this.click),this.settings.delayOnHover&&(a.off("mouseenter",this.mouseEnter),a.off("mouseleave",this.mouseLeave)),a.off("contextmenu",this.close).find("."+this.settings.namespace+"-close").off("click",this.close)}},{key:"mouseEnter",value:function(a){var o;return o=this.$growl(),o.stop(!0,!0)}},{key:"mouseLeave",value:function(a){return this.waitAndDismiss()}},{key:"click",value:function(a){if(this.settings.url!=null)return a.preventDefault(),a.stopPropagation(),window.open(this.settings.url)}},{key:"close",value:function(a){var o;return a.preventDefault(),a.stopPropagation(),o=this.$growl(),o.stop().queue(this.dismiss).queue(this.remove)}},{key:"cycle",value:function(){var a;return a=this.$growl(),a.queue(this.present).queue(this.waitAndDismiss())}},{key:"waitAndDismiss",value:function(){var a;return a=this.$growl(),a.delay(this.settings.duration).queue(this.dismiss).queue(this.remove)}},{key:"present",value:function(a){var o;return o=this.$growl(),this.bind(o),this.animate(o,this.settings.namespace+"-incoming","out",a)}},{key:"dismiss",value:function(a){var o;return o=this.$growl(),this.unbind(o),this.animate(o,this.settings.namespace+"-outgoing","in",a)}},{key:"remove",value:function(a){return this.$growl().remove(),typeof a=="function"?a():void 0}},{key:"animate",value:function(a,o){var u=arguments.length>2&&arguments[2]!==void 0?arguments[2]:"in",k=arguments[3],A;A=n.transition(a),a[u==="in"?"removeClass":"addClass"](o),a.offset().position,a[u==="in"?"addClass":"removeClass"](o),k!=null&&(A!=null?a.one(A,k):k())}},{key:"$growls",value:function(a){var o;return this.$_growls==null&&(this.$_growls=[]),(o=this.$_growls)[a]!=null?o[a]:o[a]=e("#growls-"+a)}},{key:"$growl",value:function(){return this.$_growl!=null?this.$_growl:this.$_growl=e(this.html())}},{key:"html",value:function(){return this.container(this.content())}},{key:"content",value:function(){return"<div class='"+this.settings.namespace+"-close'>"+this.settings.close+`</div>
