 ...
 * Copyright (c) 2013 Jonny Reeves; Licensed MIT */(function(e,n){"use strict";var r={},t=null,i={warnOnMissingTemplates:!1,allowOverwrite:!0,domTemplateType:"text/html",externalTemplateDataType:"text"};function s(){return t===null&&(t=n.Mustache,t===void 0&&e.error("Failed to locate Mustache instance, are you sure it has been loaded?")),t}function a(p){return r[p]!==void 0}function o(p,A){if(!i.allowOverwrite&&a(p)){e.error("TemplateName: "+p+" is already mapped.");return}r[p]=e.trim(A)}function f(){var p;arguments.length===0?p=e('script[type="'+i.domTemplateType+'"]').map(function(){return this.id}):p=e.makeArray(arguments),e.each(p,function(){var A=document.getElementById(this);A===null?e.error("No such elementId: #"+this):o(this,e(A).html())})}function S(p){var A=r[p];return delete r[p],A}function m(){r={},s().clearCache()}function D(p,A){return a(p)?s().to_html(r[p],A,r):(i.warnOnMissingTemplates&&e.error("No template registered for: "+p),"")}function v(p,A){return e.ajax({url:p,dataType:i.externalTemplateDataType}).done(function(I){e(I).filter("script").each(function(U,T){o(T.id,e(T).html())}),e.isFunction(A)&&A()})}function k(){return e.map(r,function(p,A){return A})}e.Mustache={options:i,load:v,has:a,add:o,addFromDom:f,remove:S,clear:m,render:D,templates:k,instance:t},e.fn.mustache=function(p,A,I){var U=e.extend({method:"append"},I),T=function(L,G){e(L)[U.method](D(p,G))};return this.each(function(){var L=this;e.isArray(A)?e.each(A,function(){T(L,this)}):T(L,A)})}})(window.jQuery||window.Zepto,window),function(n,r){typeof exports=="object"&&exports&&typeof exports.nodeName!="string"?r(exports):typeof define=="function"&&define.amd?define(["exports"],r):(n.Mustache={},r(n.Mustache))}(this,function(n){var r=Object.prototype.toString,t=Array.isArray||function(c){return r.call(c)==="[object Array]"};function i(w){return typeof w=="function"}function s(w){return t(w)?"array":typeof w}function a(w){return w.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&")}function o(w,c){return w!=null&&typeof w=="object"&&c in w}function f(w,c){return w!=null&&typeof w!="object"&&w.hasOwnProperty&&w.hasOwnProperty(c)}var S=RegExp.prototype.test;function m(w,c){return S.call(w,c)}var D=/\S/;function v(w){return!m(D,w)}var k={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;","`":"&#x60;","=":"&#x3D;"};function p(w){return String(w).replace(/[&<>"'`=\/]/g,function(h){return k[h]})}var A=/\s*/,I=/\s+/,U=/\s*=/,T=/\s*\}/,L=/#|\^|\/|>|\{|&|=|!/;function G(w,c){if(!w)return[];var h=[],l=[],u=[],g=!1,O=!1;function C(){if(g&&!O)for(;u.length;)delete l[u.pop()];else u=[];g=!1,O=!1}var y,d,b;function x(q){if(typeof q=="string"&&(q=q.split(I,2)),!t(q)||q.length!==2)throw new Error("Invalid tags: "+q);y=new RegExp(a(q[0])+"\\s*"),d=new RegExp("\\s*"+a(q[1])),b=new RegExp("\\s*"+a("}"+q[1]))}x(c||n.tags);for(var P=new K(w),j,E,_,F,z,B;!P.eos();){if(j=P.pos,_=P.scanUntil(y),_)for(var M=0,W=_.length;M<W;++M)F=_.charAt(M),v(F)?u.push(l.length):O=!0,l.push(["text",F,j,j+1]),j+=1,F===`
`&&C();if(!P.scan(y))break;if(g=!0,E=P.scan(L)||"name",P.scan(A),E==="="?(_=P.scanUntil(U),P.scan(U),P.scanUntil(d)):E==="{"?(_=P.scanUntil(b),P.scan(T),P.scanUntil(d),E="&"):_=P.scanUntil(d),!P.scan(d))throw new Error("Unclosed tag at "+P.pos);if(z=[E,_,j,P.pos],l.push(z),E==="#"||E==="^")h.push(z);else if(E==="/"){if(B=h.pop(),!B)throw new Error('Unopened section "'+_+'" at '+j);if(B[1]!==_)throw new Error('Unclosed section "'+B[1]+'" at '+j)}else E==="name"||E==="{"||E==="&"?O=!0:E==="="&&x(_)}if(B=h.pop(),B)throw new Error('Unclosed section "'+B[1]+'" at '+P.pos);return V(X(l))}function X(w){for(var c=[],h,l,u=0,g=w.length;u<g;++u)h=w[u],h&&(h[0]==="text"&&l&&l[0]==="text"?(l[1]+=h[1],l[3]=h[3]):(c.push(h),l=h));return c}function V(w){for(var c=[],h=c,l=[],u,g,O=0,C=w.length;O<C;++O)switch(u=w[O],u[0]){case"#":case"^":h.push(u),l.push(u),h=u[4]=[];break;case"/":g=l.pop(),g[5]=u[2],h=l.length>0?l[l.length-1][4]:c;break;default:h.push(u)}return c}function K(w){this.string=w,this.tail=w,this.pos=0}K.prototype.eos=function(){return this.tail===""},K.prototype.scan=function(c){var h=this.tail.match(c);if(!h||h.index!==0)return"";var l=h[0];return this.tail=this.tail.substring(l.length),this.pos+=l.length,l},K.prototype.scanUntil=function(c){var h=this.tail.search(c),l;switch(h){case-1:l=this.tail,this.tail="";break;case 0:l="";break;default:l=this.tail.substring(0,h),this.tail=this.tail.substring(h)}return this.pos+=l.length,l};function N(w,c){this.view=w,this.cache={".":this.view},this.parent=c}N.prototype.push=function(c){return new N(c,this)},N.prototype.lookup=function(c){var h=this.cache,l;if(h.hasOwnProperty(c))l=h[c];else{for(var u=this,g,O,C,y=!1;u;){if(c.indexOf(".")>0)for(g=u.view,O=c.split("."),C=0;g!=null&&C<O.length;)C===O.length-1&&(y=o(g,O[C])||f(g,O[C])),g=g[O[C++]];else g=u.view[c],y=o(u.view,c);if(y){l=g;break}u=u.parent}h[c]=l}return i(l)&&(l=l.call(this.view)),l};function R(){this.cache={}}R.prototype.clearCache=function(){this.cache={}},R.prototype.parse=function(c,h){var l=this.cache,u=c+":"+(h||n.tags).join(":"),g=l[u];return g==null&&(g=l[u]=G(c,h)),g},R.prototype.render=function(c,h,l,u){var g=this.parse(c,u),O=h instanceof N?h:new N(h);return this.renderTokens(g,O,l,c,u)},R.prototype.renderTokens=function(c,h,l,u,g){for(var O="",C,y,d,b=0,x=c.length;b<x;++b)d=void 0,C=c[b],y=C[0],y==="#"?d=this.renderSection(C,h,l,u):y==="^"?d=this.renderInverted(C,h,l,u):y===">"?d=this.renderPartial(C,h,l,g):y==="&"?d=this.unescapedValue(C,h):y==="name"?d=this.escapedValue(C,h):y==="text"&&(d=this.rawValue(C)),d!==void 0&&(O+=d);return O},R.prototype.renderSection=function(c,h,l,u){var g=this,O="",C=h.lookup(c[1]);function y(x){return g.render(x,h,l)}if(!!C){if(t(C))for(var d=0,b=C.length;d<b;++d)O+=this.renderTokens(c[4],h.push(C[d]),l,u);else if(typeof C=="object"||typeof C=="string"||typeof C=="number")O+=this.renderTokens(c[4],h.push(C),l,u);else if(i(C)){if(typeof u!="string")throw new Error("Cannot use higher-order sections without the original template");C=C.call(h.view,u.slice(c[3],c[5]),y),C!=null&&(O+=C)}else O+=this.renderTokens(c[4],h,l,u);return O}},R.prototype.renderInverted=function(c,h,l,u){var g=h.lookup(c[1]);if(!g||t(g)&&g.length===0)return this.renderTokens(c[4],h,l,u)},R.prototype.renderPartial=function(c,h,l,u){if(!!l){var g=i(l)?l(c[1]):l[c[1]];if(g!=null)return this.renderTokens(this.parse(g,u),h,l,g)}},R.prototype.unescapedValue=function(c,h){var l=h.lookup(c[1]);if(l!=null)return l},R.prototype.escapedValue=function(c,h){var l=h.lookup(c[1]);if(l!=null)return n.escape(l)},R.prototype.rawValue=function(c){return c[1]},n.name="mustache.js",n.version="3.0.1",n.tags=["{{","}}"];var J=new R;return n.clearCache=function(){return J.clearCache()},n.parse=function(c,h){return J.parse(c,h)},n.render=function(c,h,l,u){if(typeof c!="string")throw new TypeError('Invalid template! Template should be a "string" but "'+s(c)+'" was given as the first argument for mustache#render(template, view, partials)');return J.render(c,h,l,u)},n.to_html=function(c,h,l,u){var g=n.render(c,h,l);if(i(u))u(g);else return g},n.escape=p,n.Scanner=K,n.Context=N,n.Writer=R,n});var _createClass=function(){function e(n,r){for(var t=0;t<r.length;t++){var i=r[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(n,i.key,i)}}return function(n,r,t){return r&&e(n.prototype,r),t&&e(n,t),n}}();function _classCallCheck(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}(function(){"use strict";var e,n,r;e=jQuery,n=function(){var t=function(){function i(){_classCallCheck(this,i)}return _createClass(i,null,[{key:"transition",value:function(a){var o,f,S,m;o=a[0],f=this.transitions;for(m in f)if(S=f[m],o.style[m]!=null)return S}}]),i}();return t.transitions={webkitTransition:"webkitTransitionEnd",mozTransition:"mozTransitionEnd",oTransition:"oTransitionEnd",transition:"transitionend"},t}(),r=function(){var t=function(){_createClass(i,null,[{key:"growl",value:function(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};return new i(a)}}]);function i(){var s=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};_classCallCheck(this,i),this.render=this.render.bind(this),this.bind=this.bind.bind(this),this.unbind=this.unbind.bind(this),this.mouseEnter=this.mouseEnter.bind(this),this.mouseLeave=this.mouseLeave.bind(this),this.click=this.click.bind(this),this.close=this.close.bind(this),this.cycle=this.cycle.bind(this),this.waitAndDismiss=this.waitAndDismiss.bind(this),this.present=this.present.bind(this),this.dismiss=this.dismiss.bind(this),this.remove=this.remove.bind(this),this.animate=this.animate.bind(this),this.$growls=this.$growls.bind(this),this.$growl=this.$growl.bind(this),this.html=this.html.bind(this),this.content=this.content.bind(this),this.container=this.container.bind(this),this.settings=e.extend({},i.settings,s),this.initialize(this.settings.location),this.render()}return _createClass(i,[{key:"initialize",value:function(a){var o;return o="growls-"+a,e("body:not(:has(#"+o+"))").append('<div id="'+o+'" />')}},{key:"render",value:function(){var a;a=this.$growl(),this.$growls(this.settings.location).append(a),this.settings.fixed?this.present():this.cycle()}},{key:"bind",value:function(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:this.$growl();return a.on("click",this.click),this.settings.delayOnHover&&(a.on("mouseenter",this.mouseEnter),a.on("mouseleave",this.mouseLeave)),a.on("contextmenu",this.close).find("."+this.settings.namespace+"-close").on("click",this.close)}},{key:"unbind",value:function(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:this.$growl();return a.off("click",this.click),this.settings.delayOnHover&&(a.off("mouseenter",this.mouseEnter),a.off("mouseleave",this.mouseLeave)),a.off("contextmenu",this.close).find("."+this.settings.namespace+"-close").off("click",this.close)}},{key:"mouseEnter",value:function(a){var o;return o=this.$growl(),o.stop(!0,!0)}},{key:"mouseLeave",value:function(a){return this.waitAndDismiss()}},{key:"click",value:function(a){if(this.settings.url!=null)return a.preventDefault(),a.stopPropagation(),window.open(this.settings.url)}},{key:"close",value:function(a){var o;return a.preventDefault(),a.stopPropagation(),o=this.$growl(),o.stop().queue(this.dismiss).queue(this.remove)}},{key:"cycle",value:function(){var a;return a=this.$growl(),a.queue(this.present).queue(this.waitAndDismiss())}},{key:"waitAndDismiss",value:function(){var a;return a=this.$growl(),a.delay(this.settings.duration).queue(this.dismiss).queue(this.remove)}},{key:"present",value:function(a){var o;return o=this.$growl(),this.bind(o),this.animate(o,this.settings.namespace+"-incoming","out",a)}},{key:"dismiss",value:function(a){var o;return o=this.$growl(),this.unbind(o),this.animate(o,this.settings.namespace+"-outgoing","in",a)}},{key:"remove",value:function(a){return this.$growl().remove(),typeof a=="function"?a():void 0}},{key:"animate",value:function(a,o){var f=arguments.length>2&&arguments[2]!==void 0?arguments[2]:"in",S=arguments[3],m;m=n.transition(a),a[f==="in"?"removeClass":"addClass"](o),a.offset().position,a[f==="in"?"addClass":"removeClass"](o),S!=null&&(m!=null?a.one(m,S):S())}},{key:"$growls",value:function(a){var o;return this.$_growls==null&&(this.$_growls=[]),(o=this.$_growls)[a]!=null?o[a]:o[a]=e("#growls-"+a)}},{key:"$growl",value:function(){return this.$_growl!=null?this.$_growl:this.$_growl=e(this.html())}},{key:"html",value:function(){return this.container(this.content())}},{key:"content",value:function(){return"<div class='"+this.settings.namespace+"-close'>"+this.settings.close+`</div>
