...
- **templates:** make variable $carttpl available in smarty ([bbbcecf](https://github.com/hexonet/whmcs-ispapi-domainchecker/commit/bbbcecf9d5be69adb02e877018803af3a628e59e)), closes [#121](https://github.com/hexonet/whmcs-ispapi-domainchecker/issues/121)
...
- **phpcompatibility:** deprecated use of mysql\_ functions ([a4532ab](https://github.com/hexonet/whmcs-ispapi-domainchecker/commit/a4532ab8861eb006b89f31bc1d56a8da48735439))
...
- **migration:** to v3 of ISPAPI registrar module (switch to PHP-SDK) ([dd8df8b](https://github.com/hexonet/whmcs-ispapi-domainchecker/commit/dd8df8b6bb6a8fe431b3e6bd7b8a49b6853d3c99))
...
- **release process:** fix installation step ([e1d23a5](https://github.com/hexonet/whmcs-ispapi-domainchecker/commit/e1d23a5))
- **release process:** fix typo in install step ([322e212](https://github.com/hexonet/whmcs-ispapi-domainchecker/commit/322e212))
- **release process:** review CI/CD; lint js sources ([29a63d1](https://github.com/hexonet/whmcs-ispapi-domainchecker/commit/29a63d1))
